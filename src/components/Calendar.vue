<template>
  <div class="p-md columns is-multiline">
    ...
    <div class="column is-12 m-t-md">
      <b-button type="is-info" class="m-r-md" icon-left="arrow-left">Previous month</b-button>
      <b-button type="is-info" icon-right="arrow-right">Next month</b-button>
    </div>
  </div>
</template>
<script>
